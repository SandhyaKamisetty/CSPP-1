...
class intSet(object):
    ...
    def intersect(self, other):
        [value for value in self if value in other]
# Your task is to define the following two methods for the intSet class:
#   1. Define an intersect method that returns a new intSet
# containing elements that appear in both sets. In other words,
#      s1.intersect(s2)
#      would return a new intSet of integers that appear in both
# s1 and s2. Think carefully - what should happen if s1 and s2 have no
#      elements in common?
